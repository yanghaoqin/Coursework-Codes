...
public class In2pJ extends ConsoleProgram { 
	...
	/**
	 * postfix converts infix to postfix
	 * infix is read as a String and taken apart using the StringTokenizer
	 * then evaluated token by token
	 * capable of parentheses and unary operators as well
	 * @param string is the infix input
	 * @return returns a Queue which contains the postfix
	 */
	public Queue postfix(String string) {
		...
		// We end up with queue that contains postfix
		return outputQueue;
	}
