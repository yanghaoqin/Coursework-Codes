...
//            cust.addToBasket(new Fruit("Blue Berry",1.5,380));
            cust.addToBasket(new Fruit("abcdefghijk",1,380));
            cust.addToBasket(new SeasonalFruit("abcdefghij",1,380));
            cust.addToBasket(new Fruit("abcdefghi",1.5,180));
            cust.addToBasket(new Fruit("abcdefgh",1.5,40));
            cust.addToBasket(new Fruit("abcdefg",1.5,40));
            cust.addToBasket(new Fruit("abcdef",1.5,40));
            cust.addToBasket(new Fruit("abcde",1.5,40));
            cust.addToBasket(new Fruit("abcd",1.5,40));
            cust.addToBasket(new Fruit("abc",1.5,40));
            cust.addToBasket(new Fruit("ab",1.5,40));
            cust.addToBasket(new Fruit("a",1.5,40));
//            cust.checkOut();
            System.out.println(cust.getBasket());
//            cust.removeFromBasket(new SeasonalFruit("Red Berry",1,380));
//            cust.removeFromBasket(new Fruit("Blue Berry",1.5,40));
//            System.out.println(cust.getBasket().toString());
            System.out.println("--------------------------------------");
//            System.out.println(cust.getBasket());
