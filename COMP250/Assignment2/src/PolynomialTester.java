...
public class PolynomialTester {
	...
	{	
		...
		poly.addTermLast(new Term(12, new BigInteger("3")));
		poly.addTermLast(new Term(5, new BigInteger("3")));
		poly.addTermLast(new Term(2, new BigInteger("3")));
		poly.addTermLast(new Term(4, new BigInteger("3")));
		poly.addTermLast(new Term(12, new BigInteger("-3")));
		poly.addTermLast(new Term(0, new BigInteger("2")));
		poly.addTermLast(new Term(2, new BigInteger("3")));
		poly.addTermLast(new Term(0, new BigInteger("4")));
...
//		p1.addTerm(new Term(12, new BigInteger("3")));
//		p1.addTerm(new Term(5, new BigInteger("3")));
//		p1.addTerm(new Term(2, new BigInteger("3")));
//		p1.addTerm(new Term(4, new BigInteger("3")));
//		p1.addTerm(new Term(12, new BigInteger("3")));
//		p1.addTerm(new Term(0, new BigInteger("2")));
//		p1.addTerm(new Term(2, new BigInteger("3")));
//		p1.addTerm(new Term(0, new BigInteger("4")));
...
//		expectedSum.addTermLast(new Term(4, new BigInteger("2")));
		...
		expectedSum.addTermLast(new Term(2, new BigInteger("3")));
...
//		System.out.println(cor);
	...
	private static void testEval_1()
	{
		...
		if (p1.eval(new BigInteger("0")).compareTo(new BigInteger("-1")) == 0)
		{
